...
CREATE TABLE IF NOT EXISTS `philippe`.`events` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_events_trajet1_idx` (`idtrajet` ASC) VISIBLE)
ENGINE = MyISAM
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `philippe`.`orders` (
  ...
  `idtrajet` INT NOT NULL DEFAULT 0,
  `membre_idmembre` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`order_number`),
  INDEX `fk_orders_trajet_idx` (`idtrajet` ASC) VISIBLE,
  INDEX `fk_orders_membre1_idx` (`idmembre` ASC) VISIBLE)
ENGINE = MyISAM
AUTO_INCREMENT = 52
DEFAULT CHARACTER SET = utf8mb3;
