    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-item"><a href="http://localhost/Vroomvroom/index2.php">Se Connnecter, S'Enregistrer</a></li>
...
<!-- 	<img class="mb-4" src="design/bootstrap-logo.svg" alt="" width="72" height="57"> -->
    ...
    <h1 class="h3 mb-3 fw-normal">Manifestez vous. Nous vous contacterons prochainement.</h1>
	<br><br><br>
    ...
    <div class="form-floating">
  	<input type="text" name="Numtel_visiteur" id="pseudo" class="form-control"  required>
    <label for="floatingPassword">Numero De T&eacute;l&eacute;phone</label>
    </div>
    <div class="form-floating">
    <textarea name="Demande_visiteur" rows="12" cols="120" placeholder="Demande" required></textarea>
    </div>
