...
?>
    ...
    <input type="button" class="w-100 btn btn-lg btn-primary" onclick="window.location.replace('enregistrement.php')" style="color:red;"  name="enregistrement" value="S'enregistrer" /> <!-- Bouton d'annulation -->
    </br></br>
