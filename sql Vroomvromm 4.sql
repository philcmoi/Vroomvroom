...
CREATE TABLE IF NOT EXISTS `philippe`.`trajet` (
  ...
  INDEX `fk_trajet_membre1_idx` (`idmembre` ASC) )
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `philippe`.`events` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_events_trajet1_idx` (`idtrajet` ASC) ,
...
CREATE TABLE IF NOT EXISTS `philippe`.`orders` (
  ...
  INDEX `fk_orders_membre_idx` (`idmembre` ASC) ,
  INDEX `fk_orders_trajet1_idx` (`idtrajet` ASC) ,
  CONSTRAINT `fk_orders_membre`
    FOREIGN KEY (`idmembre`)
    REFERENCES `philippe`.`membre` (`idmembre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_trajet1`
    FOREIGN KEY (`idtrajet`)
    REFERENCES `philippe`.`trajet` (`idtrajet`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
